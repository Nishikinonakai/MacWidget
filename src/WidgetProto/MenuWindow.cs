...
public static class MenuWindow
{
    ...
    static string KindLabel(string kind) => kind switch
    {
        ...
        "timer" => Ui.T("专注计时器", "Focus Timer"),
        "note" => Ui.T("本地速记", "Local Note"),
        "awake" => Ui.T("防休眠", "Keep Awake"),
        "qr" => Ui.T("离线二维码", "Offline QR"),
        "calculator" => Ui.T("计算器", "Calculator"),
        "links" => Ui.T("快捷网址", "Quick Links"),
